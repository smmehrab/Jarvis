package com.example.jarvis.Profile;
...
public class ProfileActivity extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener, RecognitionListener {
    ...
    public void findXmlElements(){
        ...
        voiceCommandToggleButton = (ToggleButton) findViewById(R.id.profile_voice_command_toggle_btn);
    }
    ...
    public void initializeUI(){
        activityDrawerBtn.setBackgroundResource(R.drawable.icon_activity_profile);
        activityTitle.setText(R.string.profile_txt);

        userNavigationView.getMenu().findItem(R.id.user_profile_option).setCheckable(true);
        userNavigationView.getMenu().findItem(R.id.user_profile_option).setChecked(true);
